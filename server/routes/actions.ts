  ...
  (req: Request, res: Response): void => {
    try {
      ...
      res.status(200).json({
        ...
        confidence_level: decisionResult.confidence_level,
        confidence_factors: decisionResult.confidence_factors,
        evidence: decisionResult.evidence,
        human_explanation: decisionResult.human_explanation,
        technical_explanation: decisionResult.technical_explanation,
