...
import { Terminal, Play, Shield, ArrowRight, CheckCircle2 } from 'lucide-react';
...
export const CTASection: React.FC<CTASectionProps> = ({ onOpenConsole, onRunAttackDemo }) => {
  return (
    <section className="py-24 bg-[#080c14] relative border-t border-slate-800">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <h2 className="text-3xl sm:text-5xl font-black text-white tracking-tight font-mono leading-tight">
          WATCH EVERY ACTION.<br />
          <span className="text-rose-400">STOP THE WRONG ONES.</span><br />
          <span className="text-emerald-400">LET THE RIGHT ONES THROUGH.</span>
        </h2>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-4 rounded-xl font-mono text-sm font-semibold text-rose-300 bg-rose-950/40 border border-rose-500/40 hover:bg-rose-900/50 transition-all hover:scale-105"
          >
        ...
        {/* Footer info */}
        <div className="mt-16 pt-8 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between text-xs font-mono text-slate-500 gap-4">
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-emerald-400" />
            <span>SENTINEL RUNTIME v1.4.2 — OPERATIONAL</span>
          </div>
